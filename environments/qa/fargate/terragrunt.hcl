...
inputs = {
  ...
  #VPC INFO
  cidr            = "10.5.0.0/16"
  subnet_public_a = "10.5.1.0/24"
  subnet_public_b = "10.5.2.0/24"
  subnet_public_c = "10.5.3.0/24"

  subnet_private_a = "10.5.51.0/24"
  subnet_private_b = "10.5.52.0/24"
  subnet_private_c = "10.5.53.0/24"

  subnet_database_a = "10.5.101.0/24"
  subnet_database_b = "10.5.102.0/24"
  subnet_database_c = "10.5.103.0/24"
}
